...
class SelfAssessmentController extends Controller
{
    public function activateView()
    {
        ...
        return view('admin.pages.bandymasIvertinimas', compact(['data', 'activated', 'pateikta']), $viewData);
    }
...
//-------------------------------------------- ATASKAITA ------------------------------------------------------------
    ...
    public function report() {
        ...
        foreach ($teachers as $teacher) {
            ...
            if (($assessmentcheck && $surveycheck) == true) {
                ...
                array_push($scores, $assScores->{'3_hours'}, $assScores->{'3_I'}, $assScores->{'3_II'}, $assScores->{'3_III'});
                $average = intval(round(array_sum($scores) / count($scores)));
            } else {
                $average = 0;
            }

            array_push($reports, [$teacher->name, $teacher->surname, $category, $assessmentcheck, $surveycheck, $average, $teacher->id]);
        }
    ...
    public function reportView($report) {
        ...
        return view('admin.pages.report-view', compact('assessmentcheck', 'surveycheck', 'name'));
    }
}
