...
<table class="table table-striped">
  ...
  @foreach($reports as $report)
    <tr>
        <td>{{$report[0]}}</td>
        <td>{{$report[1]}}</td>
        <td style="color: red;">{{($report[3] == false or $report[4] == false) ? 'Trūksta duomenų' : $report[2]}}</td>
        <td style="color: red;">{{($report[3] == false or $report[4] == false) ? 'Trūksta duomenų' : $report[5]}}</td>
