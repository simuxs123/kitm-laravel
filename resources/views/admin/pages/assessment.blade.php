            ...
            <div class="card-content">
                <div class="card-body">
                    <p class="card-title text-muted">Kvalifikacijos kėlimas mažiau kaip 5 dienas (30 val.) per
                        mokslo metus </p>
                    <input class="form-control" type="number" name="training" placeholder="valandų skaičius" value="{{($update->{'3_hours'})}}">
                    <p class="text-muted text-decoration-underline">Už kiekvieną dieną (6 valandas) 1 balas </p>
                    <h4>VEIKLOS ĮSIVERTINIMAS BALŲ: </h4>
                    <p class="card-title text-muted">I SRITIS IŠ VISO<input class="form-control" type="number" name="I_score" value="{{($update->{'3_I'})}}">
                    <p class="card-title text-muted">Max 54 balai(-ų) </p>
                    <p class="card-title text-muted">II SRITIS IŠ VISO<input class="form-control" type="number" name="II_score" value="{{($update->{'3_II'})}}">
                    <p class="card-title text-muted">Max 30 balai(-ų) </p>
                    <p class="card-title text-muted">III SRITIS IŠ VISO<input class="form-control" type="number" name="III_score" value="{{($update->{'3_III'})}}">
