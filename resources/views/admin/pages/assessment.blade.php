...
<div id="main">
    ...
    <form class="col" method="post" action="/storeAssessment">
        ...
        <h5>KAUNO INFORMACINIŲ TECHNOLOGIJŲ MOKYKLOS
            ...
            20-<input type="text" name="dateOne">- 20-<input type="text" name="dateTwo"> MOKSLO METAIS SAVIANALIZĖS
            ANKETA
        </h5>
        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    <h5>1.1Kokie pagrindiniai iššūkiai organizuojant mokymo procesą(išvardinkite)?</h5>
                    ...
                    <div class="form-group">
                    <label>1.2. Aprašykite gerąją mokymo proceso organizavimo patirtį, pasiekimus. </label>
                    ...
                    <div class="form-group">
                    <p>1.5. Kokiose bendruomenės narių veiklose dalyvavote sprendžiant iniciatyvumo ir atsakomybės,
                        įstaigos veiklos
                        tobulinimo, planavimo, sprendimų priėmimo ir jų įgyvendinimo pokyčius</p>
                    <textarea type="text" name="participated_acts"></textarea>
                    </div>
                    <div class="form-group">
                    <p>1.6 Parengtų arba atnaujintų veiklos planų, individualių/dalyko, integruoto ugdymo programų/planų
                        skaičius
                        (įrašykite) </p>
                    ...
                    <div class="form-group">
                    <p>1.7. Kokias priemones ir būdus taikote planuojant ugdymo turinį ir išsiaiškinti mokinių mokymosi
                        poreikius ir
                    ...
                    <div class="form-group">
                    <p>1.8. Ar organizuojama pedagoginė, psichologinė ir kita pagalba mokiniui, ar ji teikiama tinkamai
                        ir ar yra
                        savalaikė. Pateikite pavyzdžių. </p>
                    <textarea type="text" name="student_assistance"></textarea>
                    </div>
                    <div class="form-group">
                    <p>1.9. Kokius mokymosi būdus bei metodus taikote pamokose, skatinančias mokinius savarankiškai
                        mokytis: </p>
                    ...
                    <div class="form-group">
                    <p>1.10. Kur patalpinate mokymo(si) medžiagą, kurią esate parengęs pamokoms ir/ar diferencijuotam
                        mokymui . </p>
                    ...
                    <div class="form-group">
                    <p>1.11. Kokiais jūsų dėstomo dalyko šių mokslo metų mokinių įgytais gebėjimai, rezultatais
                        ugdomosios veiklos
                    ...
                    <div class="form-group">
                    <p>1.12. Kokiuose dalyvavote konkursuose konkursuose, projektuose, parodose (ne mokykloje)
                        individualiai arba su
                        ugdytiniais (išvardinkite) </p>
                    <input type="text" name="competitions">
                    </div>
                    <div class="form-group">
                    <p> 1.13. BU mokytojams. Kiek mokinių pasirinko Jūsų dalyko valstybinį egzaminą (įrašykite
                        skaičių) </p>
                    ...
                    <div class="form-group">
                    <p>1.14. Profesijos mokytojams. Kiek mokinių pasirinko iš Jūsų dalyko atlikti mokyklinį technologijų
                        egzaminą? </p>
                    <input type="number">
                    ...
                    <input type="number" name="practise_in_companies"
                    ...
                    <input type="number" name="practise_in_school"
                    ...
                    <input type="text" name="data_not_provided "
                           placeholder="Duomenys nepateikti (nurodykite priežastį) ">
                    </div>
                    <div class="form-group">
                    <p>1.17. Pateikite darbdavių atsiliepimus apie pasitenkinimą absolventų įgytomis
                        kompetencijomis </p>
        ...
        <p>2.8. Kaip informaciją pateikiate ir aptariate ją su mokinių tėvais (globėjais, rūpintojais), kolegomis,
            kitais
        ...
        <input type="radio" value="Tikrai nepritariu"
        ...
        <p>Kokius naujos jums svarbius metodinių išteklių įsigijimo atvejus galėtumėte išskirti kaip reikšmingiausius
            Jūsų
            institucijoje? </p>
        ...
        <p>Ką tiesioginis vadovas turėtų tobulinti savo sprendimuose ar elgsenoje, kad jūsų veiklos rezultatas būtų
            geresnis? </p>
        ...
        <p>Grįžtamasis ryšys iš vadovų. Ar esate patenkintas bendravimu su institucijos administracija (parašykite
            komentarą) </p>
