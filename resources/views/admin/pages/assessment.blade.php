...
<div id="main">
    ...
    <form class="col" method="post" action="/storeAssessment">
        ...
        <fieldset {{ $pateikta == true ? 'disabled' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                ...
                                                <input class="form-control" type="text" name="dateOne" value="{{$update->dateOne}}">
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                    <label>Vardas</label>
                                    ...
                                    <div class="row">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                ...
                                                <input class="form-control" type="text" name="dateTwo" value="{{$update->dateTwo}}">
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                    <label>Pavarde</label>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="  ">
                            <textarea class="form-control" type="text" name="firstChallenge" value="{{($update->{'1_1_first'})}}"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="  ">
                                ...
                                <textarea class="form-control" type="text" name="firstPlan" value="{{($update->{'1_6_first'})}}" placeholder="Planai kuriuos esate parengę"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class=" c ">
                                ...
                                <textarea class="form-control" type="text" name="first_tool_or_method" value="{{($update->{'1_7_first'})}}"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class=" card-title">1.9. Kokius mokymosi būdus bei metodus taikote pamokose,
                                ...
                                mokytis: </label>
                            <div class="  ">
                                <textarea class="form-control" type="text" name="first_method_for_self_directed_learning" value="{{($update->{'1_9_first'})}}"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="  ">
                            <textarea class="form-control" type="text" name="first_happiness_for_good_student" value="{{($update->{'1_11_first'})}}"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="  ">
                                ...
                                <input class="form-control mt-2" type="number" name="didnt_pass_an_exam_technology" placeholder="Kiek egzamino neišlaikė " value="{{($update->{'1_14_neislaike'})}}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="  ">
                                ...
                                <input class="form-control mt-2" type="number" name="practise_with_project_works" placeholder="Mokinių, praktikos metų atlikusių projektinius darbus skaičius " value="{{($update->{'1_15_4'})}}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="  ">
                                ...
                                <input class="form-control mt-2" type="number" name="not_working_not_studying" placeholder="Nedirba, nesimoko (kiek)  " value="{{($update->{'1_16_3'})}}">
                                <input class="form-control mt-2" type="number" name="Signed_up_for_UT" placeholder="Užsiregistravo UT (kiek)  " value="{{($update->{'1_16_4'})}}">
                                <input class="form-control mt-2" type="number" name="Went_abroad" placeholder="Išvyko į užsienį (kiek) " value="{{($update->{'1_16_5'})}}">
                                <input class="form-control mt-2" type="text" name="other" placeholder="Kita (nurodykite) " value="{{($update->{'1_16_6'})}}">
                                <input class="form-control mt-2" type="number" name="no_data" placeholder="Nėra duomenų (kiek) " value="{{($update->{'1_16_7'})}}">
                ...
                <div class="card-content">
                    <div class="card-body form-group">
                        ...
                        <p class="text-muted">
                            ...
                            <textarea class="form-control" type="text" name="first_activity" value="{{($update->{'2_4_1'})}}"></textarea>
                            <label class="card-title">
                                2.5. Grupės vadovo veikla, bendravimas su tėvais, mokinių
                                pasitenkinimas Kas pasisekė: </label>
                                <textarea class="form-control" type="text" name="first_group_leader_activities_luck" value="{{($update->{'2_5_1'})}}"></textarea>
                        ...
                        <textarea class="form-control" type="text" name="first_provision_of_information" value="{{($update->{'2_8_1'})}}"></textarea>
                        <label class="card-title">2.9. Jūsų (kaip grupės vadovo) naudojami mokinių motyvavimo mokytis ir
                            lankyti pamokas būdai ir
                            priemonės </label>
                        <textarea class="form-control" type="text" name="first_student_motivation" value="{{($update->{'2_9_1'})}}"></textarea>
                        <label class="card-title">2.10. Dalyvavimas mokyklos socialiniame kultūriniame gyvenime. Jūsų
                            ...
                            <textarea class="form-control" type="text" name="first_events_and_extracurricular_activities" value="{{($update->{'2_10_1'})}}"></textarea>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <p class="card-title text-muted p-2">Surinktų balų suma: <input class="form-control" type="number" name="final_score" value="{{($update->{'3_sum'})}}"></p>
            </div>
            <div class="card">
                <div class="card-header">
            ...
            <div>
                <div>
                    <button type="submit" name="action" value="issaugoti" class="btn btn-success mb-1">Išsaugoti pakeitimus</button>
                </div>
                <div>
                    <button type="submit" name="action" value="pateikti" class="btn btn-primary mb-1" onclick="return confirm('Pateikus anketą nebegalėsite jos redaguoti. Ar tikrai norite užbaigti pildymą?')">Pateikti anketą</button>
                </div>
            </div>
        </fieldset>
    </form>
