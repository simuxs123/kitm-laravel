            ...
            <div class="card-content">
                <div class="card-body">
                            ...
                            <table class="table ">
                                        ...
                                        <tr>
                                            ...
                                            <th><span>Google diske </span>
                                                <input type="checkbox" value="Google diske " name="Google_disk"></th>
                                            <th><span>Eduka aplinkoje </span>
                                                <input type="checkbox" value="Eduka aplinkoje " name="Eduka"></th>
                                            <th><span>Gitlab kodo saugykla </span>
                                                <input type="checkbox" value="Gitlab kodo saugykla " name="Gitlab"></th>
                                            <th><span>Ftp paslauga </span>
                                                <input type="checkbox" value="Ftp paslauga " name="Ftp"></th>
                                            ...
                                            <th><span>Dalinuosi facebook grupėje </span>
                                                <input type="checkbox" value="Dalinuosi facebook grupėje "
                                                       name="Facebook"></th>
                                            <th><input type="text" name="other_for_learning_material"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="didnt_pass_an_exam_technology"
        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    <input type="text" name="project_executor"
        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    <input type="radio" value="Nepritariu"
                           name="availability_of_material_resources_for_students_and_teachers">
                    <input type="radio" value="Nei nepritariu, nei pritariu"
                           name="availability_of_material_resources_for_students_and_teachers">
                    <input type="radio" value="Pritariu"
                           name="availability_of_material_resources_for_students_and_teachers">
                    <input type="radio" value="Tikrai pritariu"
                           name="availability_of_material_resources_for_students_and_teachers">
