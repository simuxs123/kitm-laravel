    ...
    <div class="page-content">
        <div class="FormBig">
            ...
            <div class="page-content formBody col-12 justify-content-center">
                <form class="col" action="/action_page.php">
                    <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table  table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadio1"
                                                       id="inlineRadio1"
                                                       value="option11">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadio2"
                                                       id="inlineRadio2"
                                                       value="option21">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadio3"
                                                       id="inlineRadio3"
                                                       value="option31">
                                                <label class="form-check-label" for="inlineRadio2">1</label>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadio4"
                                                       id="inlineRadio4"
                                                       value="option41">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadio5"
                                                       id="inlineRadio5"
                                                       value="option51">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadio6"
                                                       id="inlineRadio6"
                                                       value="option61">
                                                <label class="form-check-label" for="inlineRadio4">1</label>
                                            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <em><p class="text-muted">Įvertinkite modulio kokybę kaip įvairių Jums asmeniškai svarbių aspektų visumą balais
                                    nuo 1
                                    iki
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioExt"
                                               id="inlineRadioExt"
                                               value="optionext1">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <em><p class="text-muted">Įvertinkite balais nuo 1 iki 10, kai 1 – tikrai nerekomenduočiau,  10 – tikrai rekomenduočiau
                        </p></em>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioExt2"
                                   id="inlineRadioExt2"
                                   value="optionext21">
